...
export const appMsgParser = async (engineMessage, ret, context) => {
    ...
    try {
        ...
        log.warn(LOGPRE, `Error occurred while parse message attachment: ${JSON.stringify(engineMessage)} , ${e.stack}`);
    }
    return ret;
};
