...
export type EventParserHandler = (puppet: Puppet, message: MessagePayload) => Promise<EventPayload>;
...
export async function parseEvent (puppet: Puppet, message: MessagePayload): Promise<Event<any>> {
