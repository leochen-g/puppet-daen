...
export async function parseEmotionMessagePayload (message: MessagePayload): Promise<EmojiMessagePayload> {
  const jsonPayload: EmotionXmlSchema = await xmlToJson(message.msg)
